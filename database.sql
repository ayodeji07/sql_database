...
CREATE TABLE `Employees`(`employee_id` int(10) NOT NULL, `first_name` CHAR(50) NOT NULL, `last_name` CHAR(50) NOT NULL,
`job_title` CHAR(50) NOT NULL, `salary` decimal(20) NOT NULL, `reports_to` int(10) NOT NULL,
`office_id` int(10) NOT NULL, PRIMARY KEY(`employee_id`));

-- Insert Values into employees table
INSERT INTO `Employees` VALUES(33391, "D'arcy", 'Nortunen', 'Account Executive', 62871,37270, 1);
INSERT INTO `Employees` VALUES(37270, 'Yovonnda', 'Magrannel', 'Executive Director', 633996, 37270, 10);
INSERT INTO `Employees` VALUES(37851, 'Sayer', 'Matterson', 'Statistician III', 98926, 37270, 1);
INSERT INTO `Employees` VALUES(40448, 'Mindy', 'Crissil', 'Staff Scientist', 94860, 37270, 1);
INSERT INTO `Employees` VALUES(56274, 'Keriann', 'Alloisi', 'VP Marketing', 110150, 37270, 1);
INSERT INTO `Employees` VALUES(63196, 'Alaster', 'Scutchin', 'Assistant Professor', 32179, 37270, 2);
INSERT INTO `Employees` VALUES(67009, 'North', 'de Clerc', 'Staff VP Product Management', 114257, 37270, 2);
...
CREATE TABLE `Offices`(`office_id` int(10) NOT NULL, `address` varchar(50) NOT NULL, `city` char(30) NOT NULL,
`state` char(30) NOT NULL, PRIMARY KEY(`office_id`));

-- Insert values into offices table
INSERT INTO `Offices` VALUES(1, '03 Reinke Trail', 'Cincinnati', 'OH');
INSERT INTO `Offices` VALUES(2, '5507 Becker Terrace', 'New York City', 'NY');
INSERT INTO `Offices` VALUES(3, '54 Northland Court', 'Richmond', 'VA');
INSERT INTO `Offices` VALUES(4, '08 South Crossing', 'Cincinnati', 'OH');
INSERT INTO `Offices` VALUES(5, '553 Maole Drive', 'Minneapolis', 'MN');
...
CREATE TABLE `Products`(`product_id` int(20) NOT NULL, `name` varchar(50), `quantity_in_stock` int(20),
`unit_price` decimal(5, 2), PRIMARY KEY(`product_id`));
...
INSERT INTO `Products` VALUES(4, 'Brocolinni-Gaaylan, Chinese', 90, 4.53);
...
CREATE TABLE `Clients`(`client_id` int(10) NOT NULL, `name` varchar(50), `address` varchar(50), `city` varchar(50), `state` char(2),
`phone` varchar(50), PRIMARY KEY(`client_id`));
...
-- Create Invoivces table
CREATE TABLE `Invoices`(`invoice_id` int(10) NOT NULL, `number` varchar(50), `client_id` int(10), `invoice_total` decimal(9,2),
`payment_total` decimal(9,2), `invoice_date` date, `due_date` date, `payment_date` date, PRIMARY KEY(`invoice_id`));
...
-- Create Payment_meyhods table
CREATE TABLE `Payment_methods`(`payment_method_id` int(10) NOT NULL, `name` varchar(50), PRIMARY KEY(`payment_method_id`));

-- Insert values into payment_methods table
...
-- View Payment_methods table
SELECT * FROM Payment_methods;

-- Create payments table
CREATE TABLE `Payments`(`payment_id` int(10) NOT NULL, `client_id` int(10), `invoice_id` int(10), `date` date, `amount` decimal(9,2),
`payment_method` int(10), PRIMARY KEY(`payment_id`));
...
CREATE TABLE `customers`(`customer_id` int(10) NOT NULL, `first_name` varchar(50), `last_name` varchar(50), `birth_date` date,
`phone` varchar(20), `address` varchar(50), `city` varchar(50), `state` char(50), `points` int(20), `full_name` varchar(50),
`email` varchar(50), PRIMARY KEY(`customer_id`));

-- Insert values into customers table 
INSERT INTO `customers` VALUES (1, 'Babara', 'MacCaffrey', '1986-03-28', '781-932-9754', '0 Sage Terrace', 'Waltham', 'MA', 2273, 'Babara MacCaffrey', 'babaramaccffrey@gmail.com' );
INSERT INTO `customers` VALUES (2, 'Ines', 'Brushfield', '1986-04-13', '804-427-9456', '14187 Commercial Trail', 'Hampton', 'VA',947, 'Ines Brushfield', 'inesbrushfield@gmail.com');
INSERT INTO `customers` VALUES (3, 'Freddi', 'Boagey', '1985-02-07', '719-724-7869', '251 Springs Junction', 'Colorado Springs', 'CO',2967, 'Freddi Boagey', 'freddiboagey@gmail.com');
INSERT INTO `customers` VALUES (4, 'Ambur', 'Roseburgh', '1974-04-14', '407-231-8017', '30 Arapahoe Terrace', 'Orlando', 'FL', 457, 'Ambur Roseburgh', 'amburroseburgh@gmail.com');
INSERT INTO `customers` VALUES (5, 'Clemmie', 'Betchley', '1973-11-07', NULL, '5 Spohn Circle', 'Arlington', 'TX', 3675, 'Clemie Betchley', 'clemiebetchley@gmail.com');
INSERT INTO `customers` VALUES (6, 'Elka', 'Twiddell', '1991-09-04', '312-480-8498', '7 Manley Drive', 'Chicago', 'IL', 3073, 'Elka Twiddell', 'elkatwiddell@gmail.com');
INSERT INTO `customers` VALUES (7, 'Ilene','Dowson', '1964-08-30', '615-641-4759', '50 Lillian Crossing', 'Nashville', 'TN', 1672, 'Ilene Dowson', 'ilenedowson@gmail.com');
INSERT INTO `customers` VALUES (8, 'Thacher', 'Naseby', '1993-07-17', '941-527-3977', '538 Mosinee Center', 'Sarasota', 'FL', 205, 'Thacher Naseby', 'thachernaseby@gmail.com');
INSERT INTO `customers` VALUES (9, 'Romola', 'Rumgay', '1992-05-23', '559-181-3744', '3520 Ohio Trail', 'Visalia', 'CA', 1486, 'Romola Rumgay', 'romolarumgay@gmail.com');
INSERT INTO `customers` VALUES (10, 'Levy', 'Mynett', '1969-10-13', '404-246-3370', '68 Lawn Avenue', 'Atlanta', 'GA', 796, 'Levy Mynett', 'levymynett@gmail.com');

-- View customers table
SELECT * FROM customers;

-- Create order_item_notes table
CREATE TABLE `order_item_notes`(`note_id` int(10) NOT NULL, `order_id` int(10), `product_id` int(10), `note` varchar(200), PRIMARY KEY(`note_id`));

-- Insert into order_item_notes table
INSERT INTO `order_item_notes` VALUES(1, 1, 2, 'first note');
INSERT INTO `order_item_notes` VALUES(2, 1, 2, 'second note');

-- View order_item_notes table
SELECT * FROM order_item_notes;

-- Create order_items table
CREATE TABLE `order_items`(`order_id` int(10) NOT NULL, `product_id` int(10), `quantity` int(10), `unit_price` decimal(4,2));
...
CREATE TABLE `order_statuses`(`order_status_id` int(10) NOT NULL, `name` varchar(50), PRIMARY KEY(`order_status_id`));
...
-- View order_statuses table
SELECT * FROM order_statuses;

-- Create orders table
CREATE TABLE `orders`(`order_id` int(10) NOT NULL, `customer_id` int(10), `order_date` date, `status` int(10), `comments` varchar(200),
`shipped_date` date, `shipper_id` int(10), PRIMARY KEY(`order_id`)); 
...
-- Create products table
CREATE TABLE `products`(`product_id` int(10) NOT NULL, `name` varchar(50), `quantity_in_stock` int(20), `unit_price` decimal(4,2), PRIMARY KEY(`product_id`));
...
CREATE TABLE `shippers`(`shipper_id` int(10) NOT NULL, `name` varchar(50), PRIMARY KEY(`shipper_id`));
